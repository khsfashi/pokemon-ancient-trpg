...
Status: **P2 working contract**  
Last updated: **2026-08-14**

This document freezes only world rules that have either been explicitly approved by the owner or follow directly from those approved rules without choosing among materially different creative alternatives.

If a later section has multiple equally valid creative answers, it remains an explicit Human Design Gate instead of being silently canonized.

## 1. Authoritative direction

The setting is an unofficial, project-authored ancient interpretation of the Pokémon world.
...
- forming a stable bond with a Pokémon is not assumed to be routine;
- the mandatory species scope is National Pokédex #001-#151, but full species coverage does not imply that all species are common, catchable, companion-eligible, or directly encountered.
...
Human life is organized primarily around small persistent settlements rather than cities, states, trainer institutions, or mostly nomadic bands.

Typical settlements are:

- villages, hamlets, seasonal satellite camps, fisheries, field clusters, quarry/craft sites, or defensible local compounds;
- placed where water, food, cultivable land, natural barriers, known Pokémon behavior, and defensibility make long-term habitation possible;
...
Kinship, household, clan, lineage, village obligation, reputation, age, specialist knowledge, and local leadership matter more than anonymous institutions.

The baseline supports:

- household and extended-family labor;
- local chiefs, elders, councils, respected specialists, or equivalent small-community authority;
- reciprocal obligations such as watch duty, food sharing, route clearing, escort, repair, burial, rescue, and disaster response;
- inter-settlement alliances, feuds, marriage ties, trade relationships, shared sacred sites, and negotiated access to seasonal resources;
- oral reputation and remembered conduct as important social currency.

This does **not** yet freeze a single universal government type. Different settlements may vary, provided none imply a mature centralized state without a later owner decision.

## 4. Subsistence and everyday economy

The society is settled enough to support more than pure survival, but production remains local and vulnerable to ecology, weather, Pokémon activity, and route safety.

The baseline economy can include:

- small-scale cultivation;
- gathering and managed wild-resource collection;
...
Settlements are islands of relative human control inside landscapes that are not reliably controlled by humans.

Travel therefore has meaningful risk and preparation cost.
...
- wilderness encounters need not become battles; avoidance, hiding, sacrifice of supplies, detours, observation, appeasement, retreat, and terrain use are all legitimate outcomes.
...
The baseline allows specialist scribes, lorekeepers, ritual recorders, map-makers, tally keepers, genealogists, healers, or other knowledge roles, but does not assume that every villager reads or writes.

Pokémon knowledge is therefore:
...
There is no single universal relationship between humans and Pokémon.

The setting begins from **distance, caution, negotiation, fear, observation, avoidance, opportunistic coexistence, and exceptional relationships**, not routine ownership.

A village may respond differently to different species:

- drive them away;
- avoid their territory;
- tolerate them because they control another threat;
- leave food or offerings;
- harvest traces or abandoned materials;
- interpret them as omens;
- compete with them for food or land;
- protect a nesting/migration area for practical or sacred reasons;
- maintain an inherited local truce or taboo;
- seek help from a rare person able to approach or understand them;
- form an exceptional individual bond.

A Pokémon living near humans is not automatically a pet, worker, battle partner, or owned creature.

Likewise, a person who has formed one stable Pokémon bond should be socially notable in many communities. Having several reliable Pokémon companions must never be treated as the default player fantasy unless a later explicit decision changes this rule.
...
Possible setting-consistent protection includes:
...
- rare bonded Pokémon assisting humans in exceptional cases.

The exact lethality, weapon technology, capture tools, treatment of killing Pokémon, and battle abstraction remain separate gates because they materially affect tone and mechanics.
...
Pokémon injuries are even less standardized because ordinary people are not assumed to routinely keep Pokémon companions.
...
The following are still open because choosing them now would exceed the owner's A decision:

- exact real-world historical analogue or calendar date;
- exact metallurgy/tool/weapon level;
- whether any capture technology exists and, if so, how rare/practical it is;
- whether the project uses Poké Ball-like devices at all;
...
- the prevalence and social interpretation of exceptional human–Pokémon bonds;
- the exact mechanism by which a Pokémon chooses to remain with a human;
- central religion/cosmology, if any;
- whether later-generation Pokémon/forms exist outside the mandatory Gen-I gameplay scope.

These must be resolved only when they become the next blocking P2 decision.

## 12. Consistency rules for later phases

P3-P9 content must preserve these invariants unless an explicit later owner decision supersedes them:

1. A settlement is safer than wilderness but never implies total human control of the surrounding ecology.
2. Inter-settlement movement has meaningful cost, information value, and risk.
3. Pokémon companionship is exceptional enough to carry narrative and social weight.
4. People can possess sophisticated local ecological knowledge without possessing a modern universal Pokédex worldview.
5. Occupations arise from village survival, exchange, travel, knowledge, and Pokémon ecology rather than generic fantasy magic.
6. A species dossier may make a particular Pokémon locally familiar without making Pokémon as a whole domesticated or normalized.
7. The world can contain craftsmanship, culture, ritual, trade, and specialist knowledge without becoming a Hisui-like institutional frontier society.
8. Later systems must prefer explicit local exceptions over silently weakening the global pre-Hisui baseline.
